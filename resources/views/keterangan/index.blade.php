...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/keterangan/add" id="add-keterangan">
                    ...
                    <tr>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/keterangan/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/keterangan/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-keterangan').off('click').click(function(event) {
                ...
                $('.aplay_code').load('/keterangan/edit/' + parameterString, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/keterangan/edit/' +
                        parameterString);
                });
            });
            ...
            //     event.preventDefault();
            //     $('.aplay_code').load('/keterangan/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/keterangan/delete');
            //     });
            // })



            $(document).on('click', '#delete-keterangan', function(event) {
                event.preventDefault();
                ...
                Swal.fire({
                    title: 'Apakah Anda yakin ingin menghapus keterangan ini ?',
            ...
            $(document).on('click', '#delete', function(event) {
                ...
                var id = $(this).data('id');
                var url =
                    "/keterangan/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                Swal.fire({
                                    ...
                                    // Lakukan perubahan halaman atau tindakan lainnya setelah data berhasil dihapus
                                    window.location.href = '/keterangan';
                                });
                            },
                            error: function(xhr) {
                                // Tampilkan SweetAlert untuk kesalahan
