...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/hadiah/add" id="add-hadiah">
            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ number_format($d['hadiah'], 0, ',', '.') }}</span></td>
                        <td><span class="name">{{ $d['persentase'] . '%' }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/hadiah/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/hadiah/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-hadiah').off('click').click(function(event) {
                ...
                window.location.href = '/hadiah/edit/' + parameterString;
            });

            // $(document).on('click', '#delete', function(event) {
            //     event.preventDefault();
            //     $('.aplay_code').load('/hadiah/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/hadiah/delete');
            //     });
            // })



            $(document).on('click', '#delete-hadiah', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/hadiah/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = '/hadiah/index/';
                                });
                            },
                            error: function(xhr) {
