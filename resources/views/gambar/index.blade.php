...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/gambar/add" id="add-gambar">
                    ...
                    <tr>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/gambar/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/gambar/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-gambar').off('click').click(function(event) {
                ...
                window.location.href = '/gambar/edit/' + parameterString;
            });
            ...
            //     event.preventDefault();
            //     $('.aplay_code').load('/gambar/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/gambar/delete');
            //     });
            // })



            $(document).on('click', '#delete-gambar', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/gambar/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = '/gambar/index/' +
                                        website;
                                });
                            },
                            error: function(xhr) {
