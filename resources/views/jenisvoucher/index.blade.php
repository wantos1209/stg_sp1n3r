...
@section('container')
            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ $d->index }}</span></td>
                        <td><span class="name">{{ $d->nama }}</span></td>
                        <td><span class="name">{{ number_format($d->saldo_point, 0, '.', '.') }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/jenisvoucher/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/jenisvoucher/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-jenisvoucher').off('click').click(function(event) {
                ...
                $('.aplay_code').load('/jenisvoucher/edit/' + parameterString, function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/jenisvoucher/edit/' +
                        parameterString);
                });
            });


            $(document).off('click', '#add-jenisvoucher').on('click', '#add-jenisvoucher', function(event) {
                event.preventDefault();
                $('.aplay_code').load('/jenisvoucher/add', function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/jenisvoucher/add');
                });
            });
            // $(document).on('click', '#delete', function(event) {
            //     event.preventDefault();
            //     $('.aplay_code').load('/jenisvoucher/delete', function() {
            //         adjustElementSize();
            //         localStorage.setItem('lastPage', '/jenisvoucher/delete');
            //     });
            // })



            $(document).on('click', '#delete-jenisvoucher', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/jenisvoucher/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
