...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/budget/add" id="add-budget">
            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ $d['jenis_event'] }}</span></td>
                        <td><span class="name">{{ $d['nama_event'] }}</span></td>
                        <td><span class="name">{{ number_format($d['budget'], 0, ',', '.') }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/budget/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/budget/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-budget').off('click').click(function(event) {
                ...
                window.location.href = '/budget/edit/' + parameterString;
            });


            $(document).on('click', '#delete', function(event) {
                event.preventDefault();
                $('.aplay_code').load('/budget/delete', function() {
                    adjustElementSize();
                    localStorage.setItem('lastPage', '/budget/delete');
                });
            })



            $(document).on('click', '#delete-budget', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/budget/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                Swal.fire({
                                    ...
                                    // Lakukan perubahan halaman atau tindakan lainnya setelah data berhasil dihapus
                                    window.location.href = '/budget/index/';
                                });
                            },
                            error: function(xhr) {
                                // Tampilkan SweetAlert untuk kesalahan
