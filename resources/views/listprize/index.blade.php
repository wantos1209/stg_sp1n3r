...
@section('container')
    ...
    <div class="sec_table">
        ...
        <div class="group_act_butt">
            <a href="/listprize/add" id="add-listprize">
            ...
            <tbody>
                ...
                @foreach ($data as $index => $d)
                    <tr>
                        ...
                        <td><span class="name">{{ $d['id'] }}</span></td>
                        <td><span class="name">{{ $d['nama'] }}</span></td>
                        <td><span class="name">{{ $d['unit'] }}</span></td>
                        ...
                        <td class="kolom_action">
                            ...
                            <div class="action_crud" id="1" style="display: none;">
                                <a href="/listprize/view/{{ $d['id'] }}" id="view">
                                ...
                                <a href="/listprize/edit/{{ $d['id'] }}" id="edit">
                                    <div class="list_action">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#update-listprize').off('click').click(function(event) {
                ...
                window.location.href = '/listprize/edit/' + parameterString;
            });

            $(document).on('click', '#delete-listprize', function(event) {
                event.preventDefault();
                ...
                var url =
                    "/listprize/delete/"; // Ubah URL sesuai dengan endpoint delete yang sesuai
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href = '/listprize/index';
                                });
                            },
                            error: function(xhr) {
